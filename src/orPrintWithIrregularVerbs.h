!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! 2025.11.25 orPrintWithIrregularVerbs (English)
...
default        orPrintWithIrregularVerbs_STAGE  0;
!--------------------------------------------------------------------------------------
! INCLUDE DEPENDENCIES
#include "orPrint";
!--------------------------------------------------------------------------------------
#ifnot;
#ifndef        orPrintWithIrregularVerbs_STAGE; message fatalerror orXFErrorInclude; #endif;
#iftrue(       orPrintWithIrregularVerbs_STAGE  < LIBRARY_STAGE);
   #undef      orPrintWithIrregularVerbs_STAGE  ;
   Constant    orPrintWithIrregularVerbs_STAGE  LIBRARY_STAGE;
   #ifdef      orPrintWithIrregularVerbs_STAGE  ; #endif;
   #ifndef orExtensionFrameworkBrief; message "   orPrintWithIrregularVerbs...";#endif;
!======================================================================================
! BEFORE PARSER
...
[hashString str i hsh;
   ...
   for(i=0:i<str.getLength():i++){
      hsh=hsh*$1b3;
      hsh=util.orNum.xorBits(hsh,util.orChar.toLower(str.getChar(i)));
   }
   hsh=util.orNum.andBits(hsh,$ffff);
   str.free();
   return hsh;
];
